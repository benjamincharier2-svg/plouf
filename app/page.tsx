...
const jsonLd = {
  ...
  areaServed: [
    ...
    { "@type": "City", name: "Le Haillan" },
    { "@type": "City", name: "Pessac" },
    { "@type": "City", name: "Lesparre-Médoc" },
    { "@type": "City", name: "Soulac-sur-Mer" },
    { "@type": "City", name: "Le Verdon-sur-Mer" },
    { "@type": "City", name: "Saint-Vivien-de-Médoc" },
    { "@type": "City", name: "Vendays-Montalivet" },
    { "@type": "City", name: "Hourtin" },
    { "@type": "City", name: "Naujac-sur-Mer" },
    { "@type": "City", name: "Talais" },
